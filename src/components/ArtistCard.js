    ...
    >
      <Link href={`/artists/${artist.slug}`} className="group block relative overflow-hidden">
        <div className="relative aspect-[3/4] overflow-hidden bg-[#141414]">
          ...
          <div className="absolute inset-0 ring-1 ring-inset ring-white/0 group-hover:ring-white/10 transition-all duration-300" />
          <div className="absolute bottom-0 left-0 right-0 p-5">
            ...
            <motion.span
              initial={false}
              className="inline-block mt-2 text-[10px] text-white/0 group-hover:text-white/50 transition-all duration-300 tracking-widest uppercase"
            >
              View Profile →
            </motion.span>
          </div>
