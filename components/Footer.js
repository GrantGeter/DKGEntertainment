        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-white/40 text-sm leading-relaxed max-w-xs">
              DKG Entertainment — A music management and events company rooted in culture, community, and authentic artistry.
            </p>
          ...
          <div>
            <h4 className="text-xs font-bold tracking-widest uppercase text-white/30 mb-6">Navigate</h4>
          ...
          <div>
            <h4 className="text-xs font-bold tracking-widest uppercase text-white/30 mb-6">Newsletter</h4>
            <p className="text-sm text-white/40 mb-4">Stay updated on tours, releases, and events.</p>
